...
// Add admin script
function sekf_options_admin_scripts() {
...
add_action('admin_init', 'sekf_options_admin_scripts');

// Add admin script
function sekf_options_admin_styles() {
...
add_action('admin_init', 'sekf_options_admin_styles');